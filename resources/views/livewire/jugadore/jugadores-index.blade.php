         ...
         @foreach ($jugadores as $jugador)
             <div
                 ...
                 <div class="flex justify-center mb-4">
                     ...
                     @else
                         <div
                             ...
                             <svg class="w-10 h-10 text-gray-400 dark:text-gray-600" fill="currentColor"
                                 viewBox="0 0 20 18">
                                 <path
                 ...
                 <div class="flex justify-center my-2">
                     ...
                     @else
                         <span
                             class="inline-flex w-6 h-6 items-center justify-center rounded-full bg-red-100 text-red-800">
                             ✗
                         </span>
                     @endif
                 </div>
