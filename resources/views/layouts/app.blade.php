...
<body class="flex flex-col min-h-screen bg-gray-100 dark:bg-gray-900"">
    @auth
        ...
        <footer
            class="flex justify-between p-2 ml-64 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 h-16  items-center ">
            <!-- Texto -->
            <p class="text-sm">
                © {{ date('Y') }} <span class="font-semibold text-orange-500">Futbol de Veteranos Bella Vista</span>.
    ...
    @guest
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            ...
            {{ $slot }}
            <footer
                class="fixed  bottom-0 left-0 w-full flex justify-between p-2  bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 h-16 items-center">
                <p class="text-sm">
                    © {{ date('Y') }} <span class="font-semibold text-orange-500">Futbol de Veteranos Bella
                        Vista</span>. Todos los derechos reservados.
                </p>
                <!-- Línea divisoria -->
                <div class="border-t border-gray-300 dark:border-gray-700 mt-2"></div>
